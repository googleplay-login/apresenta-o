...
> **O que existe hoje:** mundo 3D navegável com **seis** ilhas suspensas e pontes, um **avatar que
> anda** pelo capim e pelas pontes (com câmera de terceira pessoa, voo livre e vista de mapa), o
> ciclo de estudo completo das seis primeiras unidades — capítulos 1 a 5 do livro (missão, estudo,
...
> escrito na tela.
>
> **O que ainda não existe:** expansão para as unidades seguintes (os capítulos 6 em diante),
...
Outros comandos:
    ...
    npm test         # 700 testes: regras, geometria, chão caminhável, avatar, mundo 3D, conteúdo, leitura, interface e a conferência no Python de verdade
